...
#input_dataframe = pd.read_csv("50kv3_mFWD_small.output.txt", sep="\t", skiprows=9)

#conversion_dir = "variant_position_files"
#species = "bos_taurus"
#assembly = "ARS-UCD1_2_Btau5_0_1Y"
...
#var_list, logfile2_text, alt_bool = vff.var_match(variant_files, conversion_dir, input_dataframe, "50kv3_mFWD_small.output.txt", converting_file,
#                                                  assembly, species)
#var_df = vff.get_var_df(conversion_dir, var_list[0], assembly, species, alt_bool)
#logfile_name = "test_logfile.txt"

#map_output = create_map_file("50kv3_mFWD_small.output", input_dataframe, var_df, species, logfile_name)


#output = create_ped_file("50kv3_mFWD_small.output", input_dataframe, logfile_name)