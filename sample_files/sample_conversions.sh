...
# Check whether Illumina Forward format file is correctly formatted, specifying the key file directory
python ../SNP_conversion.py check_format --input-dir input_files --file-list 50kv3_mFWD_14June2019.txt --input-format FWD --assembly UMD3_1_chromosomes --key-dir variant_position_files --species bos_taurus > test_output/check_forward_files_output.txt
